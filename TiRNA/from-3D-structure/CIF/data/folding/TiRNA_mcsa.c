...
float UCoS(int i1,int j1,int k1,int k2,float x[1000],float y[1000],float z[1000])
{
 	...
 	if (Bulge==1&&j1-k2>=12) {dco_1=5.0; dco_2=2*5.0; kdco_1=2.5; kdco_2=2*2.5; }
 	else {dco_1=5.0; dco_2=5.0; kdco_1=2.5; kdco_2=2.5; }   // 针对bulge做修正，如果间隔3nt，则最优距离dco=2dco，kdco=2kdco；
